...
simulate_cases = function(data_consts, lambda, phi_inv, relapse_clinical_immunity) {
  ...
  data = data_init(data_consts,
                   ...
                   eps = 0,
                   kappa = 3)
  params = list(lambda=lambda, phi_inv=phi_inv, relapse_clinical_immunity)
  synth_df = my_simulate_data(
    file = "../stan/temperate_8_1.stan",
    path = "sim_data",
...
scenarios = expand_grid(
  lambda = 0.045,
  phi_inv = 0.1,
  relapse_clinical_immunity = c(0.33, 0.67),
...
my_sampling = function(data_consts, ts, cases, true_lambda, true_phi_inv, true_relapse_clinical_immunity) {
  ...
  fit = sampling(stan_model("../stan/temperate_8_1.stan"),
                 data = data,
                 iter = n_iter,

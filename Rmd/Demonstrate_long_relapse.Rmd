...
true_params = list(lambda = 1, phi_inv = 0.1, relapse_clinical_immunity = 0)
...
synth_df = my_simulate_data_list(
    file = "../stan/temperate_6_1.stan",
    path = "sim_data",
    data_name = "nonstationary",
    input_data = data_sim,
    param_values = true_params,
...
tictoc::tic()
samp = sampling(stan_model("../stan/temperate_7_1.stan"),
                data = data_recovery,
                iter = 100,
                chains = n_chains,

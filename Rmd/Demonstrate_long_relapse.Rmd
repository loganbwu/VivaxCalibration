...
data = data_init(data_null,
                 ...
                 gamma_l = 0,
                 gamma_d = 0)
data$y0 = state_init_3(data, list(1) %>% setNames(paste0("Sl", data$n_dormant+1)))
true_params = list(lambda=1, phi_inv=0.1, relapse_clinical_immunity=0.8)
...
data = data_init(data_null,
                 ...
                 gamma_l = 0,
                 gamma_d = 0)
data$y0 = state_init_3(data, Sl1=1)

true_params = list(lambda = 1, phi_inv = 0.1, relapse_clinical_immunity = 1e-16)
...
data_1$y0 = state_init_3(data, Sl12 = 1)
data_2$y0 = state_init_3(data, Sl1 = 0.5, Sl12 = 0.5)
data_3$y0 = state_init_3(data, Sl1 = 1)
...
data = data_init(data_null,
                 ...
                 kappa = 5,
                 phase = 0)
data$y0 = state_init_3(data, I0 = 0.01)
data_1 = data_2 = data_3 = data
data_1$p_silent = 0
data_2$p_silent = 0.5
data_3$p_silent = 1
...
true_params = list(lambda = 0.03, phi_inv = 0.1, relapse_clinical_immunity = 0.5)
...
posterior_seasonal = rstan::extract(samp, c("lambda", "phi_inv", "relapse_clinical_immunity")) %>%
  as_tibble() %>%
...
samp_immunity = sampling(stan_model("../stan/temperate_7_1.stan"),
                data = data_recovery,
                iter = 100,
                chains = 4,
                init = rep(list(theta_init), n_chains), # Start from MLE solution

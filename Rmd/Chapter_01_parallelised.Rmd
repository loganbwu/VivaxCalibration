...
# for (i in seq_len(nrow(data_scenarios_long))) {
#   print(i)
#   fits_all[[i]] = run_scenario_method(i, refresh=NULL)
# }
...
# for (i in seq_len(length(fits_all))) {
#   result = fits_all[[i]]$fit
#   if (result@mode == 2) {
#     # redo
#     message("Redoing row ", i)
#     fits_all[[i]] = run_scenario_method(i, force=T, refresh=NULL)
#   }
# }
tictoc::toc()

...
n_chains = 1
n_repetitions = 2 # how many times to duplicate each scenario
...
fits_scenarios = pbmclapply(seq_len(nrow(scenarios_long)), fit_ix)
tictoc::toc()
```
...
scenarios_long$est_incidence[[10]] %>%
  ggplot(aes(x=ts/years, y=incidence, color=rep, group=interaction(trace, rep))) +

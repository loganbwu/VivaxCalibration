...
model_file = "../stan/temperate_10_1_ascertainment.stan"
...
filename = paste0("../plots/china_", str_to_lower(selected_region), "_posterior_norci.png")
...
filename = paste0("../plots/china_", str_to_lower(selected_region), "_incidence_norci.png")
ggsave(filename, width=8, height=4)
```

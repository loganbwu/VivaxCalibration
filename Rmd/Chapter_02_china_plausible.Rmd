...
model_file = "../stan/temperate_9_1_delayed.stan"
...
samp = sampling(model,
                ...
                cores = n_chains,
                pars = c("lambda", "phi", "alpha", "beta", "p_long", "p_silent", "incidence", "sim_cases"))
tictoc::toc()
```

```{r}
# inspect parameter posteriors
parameters = c("lambda", "phi", "alpha", "beta", "p_long", "p_silent")
...
ggsave("../plots/china_incidence_norci.png", width=8, height=4)
```

...
synth_data = simulate_data("champagne2022.stan", data_name="dummy_data", input_data=data_sis,
                           vars=c("incidence"), param_values=list(lambda=0.01, phi_inv=0.001))
stansim_output1 <- fit_models(sim_name = "dummy_fit",
                              sim_data = synth_data,
                              stan_args = list(file = "champagne2022.stan"))
stansim_output2 <- fit_models(sim_name = "dummy_fit2",
                              sim_data = synth_data,
                              stan_args = list(file = "champagne2022.stan"))
synth_collection = collect_simulations(
...
data_sis_generate <- list(n_times = n_times, y0 = y0, t0 = t0, ts = t, N = N,
                          r = 1./60, # r
                          gammal = 1./223, # gammal
                          f = 1./72, # f
                          alpha = 0.21, # alpha
...
predictions = stan(file = "champagne2022_generation.stan", data = data_sis_generate, chains = 1, iter = 1, algorithm = "Fixed_param")

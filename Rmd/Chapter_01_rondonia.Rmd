...
p_seasonal_ci + p_ns_ci + plot_layout(guides = "collect") +
  plot_annotation(title = "Posterior model fits",
                  tag_levels = "A")
ggsave("plots/ci.png", width=8, height=4)

p_seasonal_posterior + p_ns_posterior + theme(legend.position="none") +
  plot_layout(guides = "collect") +
  plot_annotation("Posterior parameter estimates",
                  tag_levels = "A")
  
ggsave("plots/posterior.png", width=8, height=4)
```
...
posterior_comparison %>%
  ...
  labs(title = "True seasonality added to nonseasonal posterior fit",
